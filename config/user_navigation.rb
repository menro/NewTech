...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :more_menu, content_tag(:i, nil, :id => 'caret') << "", '#' do |more_menu|
      more_menu.item :add_a_job, content_tag(:i, nil, :class => 'icon-plus') << t(:'simple_navigation.post_a_job'), new_job_url
      more_menu.item :add_you_company123, content_tag(:i, nil, :class => 'icon-plus') << t(:'simple_navigation.add_you_company'), new_company_url
    end
  end
