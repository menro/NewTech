...
ActiveRecord::Schema.define(:version => 20140220175409) do
  ...
  create_table "categories", :force => true do |t|
    ...
    t.datetime "created_at",               :null => false
    t.datetime "updated_at",               :null => false
    t.string   "marker_icon_file_name"
    t.string   "marker_icon_content_type"
    t.integer  "marker_icon_file_size"
    t.datetime "marker_icon_updated_at"
  end
  ...
  create_table "cities_zipcodes", :id => false, :force => true do |t|
    t.integer "city_id"
    t.integer "zipcode_id"
  end

  add_index "cities_zipcodes", ["city_id", "zipcode_id"], :name => "index_cities_zipcodes_on_city_id_and_zipcode_id"
  ...
  create_table "disciplines", :force => true do |t|
    ...
    t.boolean  "is_price_required", :default => true
  end
  ...
  create_table "users_links", :force => true do |t|
    t.integer  "user_id"
    t.string   "link_url"
    t.string   "name"
    t.datetime "created_at", :null => false
  ...
  add_index "users_links", ["user_id"], :name => "index_users_links_on_user_id"
